...
[Get started](#windows-installation) · [Run a scrolling session](#optional-auto-scroll) · [Schedule delivery](#automatic-scheduling) · [Roadmap](#roadmap--planned-for-future-versions)
...
The local JSON is excluded by `.gitignore`. Do not copy its contents into issues, screenshots, examples, or this README. Shell environment overrides can supersede saved settings; see [Configuration](#configuration).
